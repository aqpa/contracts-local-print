...
public class UserController {
    ...
    public String showUpdateUserDetails(@RequestParam("id") long id, ModelMap modelMap) {
    ...
    public String showPassword(@RequestParam("id") long id, ModelMap modelMap) {
        UserDetails userDetails = userDetailsRepository.findByUserId(id);
        modelMap.addAttribute("userDetails", userDetails);
        return "changePassword";
    }
    @RequestMapping("/changePassword")
    public String changePassword(@RequestParam("userId") long userId, @RequestParam("password") String password, ModelMap modelMap) {
