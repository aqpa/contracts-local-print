...
<pre>
    ...
    <a href="dates?id=${userDetails.userId}&method=printAllBeginning">Drukuj dla wszystkich - początek pracy</a>                  <a href="datesTwo?id=${userDetails.userId}&method=printAllEnd">Drukuj dla wszystkich - rozliczenie</a>
<form action="checked" method="post">
<input type="submit" name="beginning" value="Drukuj zaznaczonych - początek pracy"/>                                <input type="submit" name="end" value="Drukuj zaznaczonych - rozliczenie"/>
...
<tr>
    ...
    <td>${worker.passport}</td>
      <td>  <a href="deactivateWorker?id=${worker.id}">deaktywuj</a></td>
      <td>  <a href="showUpdateWorker?id=${worker.id}">edytuj</a></td>
      <td>  <a href="dates?id=${worker.id}&method=printBeginning">drukuj umowy</a></td>
      <td>  <a href="datesTwo?id=${worker.id}&method=printEnd">drukuj rozliczenie</a></td>
</tr>
    </pre>
